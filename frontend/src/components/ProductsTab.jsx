...
export default function ProductsTab() {
    ...
    const [tabs, setTabs] = useState([
        { name: 'All', current: true, icon: ToDoIcon },
        { name: 'Active', current: false, icon: ListViewIcon },
        { name: 'Draft', current: false, icon: KanbanIcon },
    ]);
    ...
    return (
        <div className="pb-3 flex justify-between">
            ...
            <div className="flex items-center">
                <span className="text-[#9B9B9B] mr-4 cursor-pointer">Import</span>
                <span className="text-[#9B9B9B] mr-4 cursor-pointer">Export</span>
                ...
                <button className="flex items-center bg-primary-light px-3 py-2 rounded-l-md rounded-r-none">
                    ...
                    <span className="text-white mr-1">Add</span>
                </button>
                            ...
                            <div className="py-1">
                                {DROPDOWN_OPTIONS.map(({ label, icon }) => (
                                    <button
                                        ...
                                        className="px-4 py-2 text-sm text-black w-full text-left hover:bg-gray-200 flex items-center space-x-2"
                                    >
